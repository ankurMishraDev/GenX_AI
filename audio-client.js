...
class AudioClient {
  ...
  stopRecording() {
    ...
    // Note: We do NOT send "end" message here for toggle recording
    // "end" should only be sent when closing the entire session
    // For toggle recording, we just stop capturing/sending audio chunks
  }
  ...
  close() {
    ...
    // Send "end" message to server before closing (session is ending)
